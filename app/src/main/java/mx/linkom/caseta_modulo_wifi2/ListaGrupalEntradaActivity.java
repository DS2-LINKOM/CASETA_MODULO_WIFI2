...
import mx.linkom.caseta_modulo_wifi2.adaptadores.ListasClassGrid;
import mx.linkom.caseta_modulo_wifi2.adaptadores.adaptador_Modulo;


public class ListaGrupalEntradaActivity extends mx.linkom.caseta_modulo_wifi2.Menu implements View.OnClickListener {
   ...
   // Handler handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(ListaGrupalEntradaActivity.this, ProtectorPantalla.class);
    ...
    public void invitados() {
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/vst_gru_1.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
