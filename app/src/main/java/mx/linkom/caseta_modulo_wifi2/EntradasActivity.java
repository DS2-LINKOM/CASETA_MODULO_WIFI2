...
public class EntradasActivity extends mx.linkom.caseta_modulo_wifi2.Menu2{
    ...
    public void placas() {
        ...
        String url = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/vst_reg_4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    ...
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_modulo_wifi2.AccesoRegistroActivity.class);
                    startActivity(i);
                    finish();
                }else {
