...
public class ListaGrupalSalidaActivity extends mx.linkom.caseta_modulo_wifi2.Menu implements View.OnClickListener {
    ...
    public void invitados() {
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/vst_gru_3.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
