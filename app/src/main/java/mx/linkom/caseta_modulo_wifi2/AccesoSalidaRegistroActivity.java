...
public class AccesoSalidaRegistroActivity extends mx.linkom.caseta_modulo_wifi2.Menu2{
    Configuracion Conf;
    ...
    public void dtlLugar(final String idUsuario){
        String URLResidencial = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/vst_reg_6.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
    ...
    public void registrar (){
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/vst_reg_7.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
