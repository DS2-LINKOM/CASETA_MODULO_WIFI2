...
public class AccesoAutosSalidasActivity extends mx.linkom.caseta_modulo_wifi2.Menu {
    Configuracion Conf;
    ...
    public void Autos(){
        ...
        String url = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/auto1.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
    ...
    public void cajones(){
        String URLResidencial = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/auto5.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
    ...
    public void salidas(){
        ...
        String url = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/auto2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
    ...
    public void sincasa(){
        ...
        try {
            Notificar(ja2.getString(1).trim() + " " + ja2.getString(2).trim() + " " + ja2.getString(3).trim());
        } catch (JSONException e) {
            e.printStackTrace();
        }
        mp2.start();
    ...
    public void Registrar_pluma(){
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/plumas_registro_12.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                try {
                    params.put("id_residencial", Conf.getResid().trim());
                    params.put("id_auto", ja7.getString(0).trim());
    ...
    public void Registrar (){
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/auto4.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
            ...
            public void onResponse(String response) {
                if(response.equals("success")){
                    ...
                    try {
                        ...
                        tvMensaje2.setText(ja3.getString(0).trim());
    ...
    public void EnviarBT2() {
        Toast.makeText(AccesoAutosSalidasActivity.this, "Registro Exitoso", Toast.LENGTH_LONG).show();
    ...
    public void Notificar(String Visita){
        ...
        String URL = "https://demoarboledas.privadaarboledas.net/plataforma/casetaV2/controlador/WIFI/vst_php9.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void finalizarApp() {
        Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_modulo_wifi2.DashboardSalidas.class);
        startActivity(i);
        finish();
    ...
    public void onBackPressed(){
        ...
        mp.stop();
        mp2.stop();
        Intent intent = new Intent(getApplicationContext(), mx.linkom.caseta_modulo_wifi2.DashboardSalidas.class);
        startActivity(intent);
        finish();
    }
}
